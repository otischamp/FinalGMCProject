...
export const createTask = async (req,res) => {
    try {
        ...
        text = text + `The task priority is set to ${priority} priority so check and act accordingly. The task date is ${new Date(date).toDateString()}. Thank You!`;
...
export const duplicateTask = async (req,res) => {
    try {
       ...
       newTask.stage = task.stage;
        ...
        text = text + `The task priority is set to ${task.priority} priority so check and act accordingly. The task date is ${task.date.toDateString()}. Thank You!`;
